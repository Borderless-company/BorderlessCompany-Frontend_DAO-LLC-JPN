...
type ContrySelectionProps = {
  pageHandler: (page: number) => void;
};

export const ContrySelection: FC<ContrySelectionProps> = ({ pageHandler }) => {
  return (
    <div className="flex flex-col items-start justify-center gap-4 w-full max-w-lg p-8">
      ...
      <div className="flex flex-col items-start justify-start gap-2 w-full">
        ...
        <div className="flex flex-col items-start justify-start gap-0 w-full h-auto overflow-hidden bg-primary-foreground rounded-xl border-1 border-primary-outline">
          <CountrySelectionItem countryCode="JP" onPress={() => pageHandler(1)}>
            日本の法人
